...
add_filter('template_include', array('custom_Wrapping', 'wrap'), 109);
/**
 * Theme Wrapper
 */
class custom_Wrapping
{
	...
	{
		$this->templates = apply_filters('custom_wrap_' . $this->slug, $this->templates);
